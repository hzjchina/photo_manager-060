...
import top.kikt.imagescanner.core.utils.RequestTypeUtils
        ...
        override fun onDenied(deniedPermissions: MutableList<String>, grantedPermissions: MutableList<String>) {
          ...
          if (call.method == "requestPermission") {
            ...
            if (grantedPermissions.containsAll(arrayListOf(Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE)) || (
                      Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q && grantedPermissions.containsAll(arrayListOf(Manifest.permission.READ_MEDIA_IMAGES))
                      /// 这里需要处理其 READ_MEDIA_AUDIO （READ_MEDIA_VIDEO READ_MEDIA_IMAGES 同一权限）
                    )) {
